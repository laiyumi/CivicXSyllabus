    ...
    <div className="grid grid-cols-12">
      <div className="col-start-2 col-span-10 my-10">
        <div className="flex flex-col gap-8">
          ...
          <ul className="list-disc pl-8">
            ...
            <li className="py-2">
              <p>
                ...
                in this Agreement) refers to Civic X Syllabus, 360 Huntington
                Ave, Boston, MA 02115.
              </p>
            </li>
            <li className="py-2">
            ...
            <li className="py-2">
              <p>
                <strong>Website</strong> refers to Civic X Syllabus, accessible
                from{" "}
                <a
          ...
          <h2 className="text-xl font-bold">Children&apos; Privacy</h2>
          <p>
